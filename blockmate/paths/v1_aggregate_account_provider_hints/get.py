...
class BaseApi(api_client.Api):
    ...
    def _account_provider_hints_list_oapg(
        self: api_client.Api,
        ...
        host = self._get_host_oapg('account_provider_hints_list', _servers, host_index)
...
class AccountProviderHintsList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def account_provider_hints_list(
        self: BaseApi,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        host_index: typing.Optional[int] = None,
        stream: bool = False,
        ...
        return self._account_provider_hints_list_oapg(

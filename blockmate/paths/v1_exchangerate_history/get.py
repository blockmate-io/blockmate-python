...
# query params
PairSchema = schemas.StrSchema
DaysSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'pair': typing.Union[PairSchema, str, ],
...
request_query_pair = api_client.QueryParameter(
    name="pair",
...
class BaseApi(api_client.Api):
    ...
    def _get_historical_exchange_rate_oapg(
        self: api_client.Api,
...
class GetHistoricalExchangeRate(BaseApi):

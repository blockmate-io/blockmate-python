...
class BaseApi(api_client.Api):
    ...
    def _user_api_authenticate_project_oapg(
        self: api_client.Api,
        ...
        host = self._get_host_oapg('user_api_authenticate_project', _servers, host_index)
...
class UserApiAuthenticateProject(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def user_api_authenticate_project(
        self: BaseApi,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        host_index: typing.Optional[int] = None,
        stream: bool = False,
        ...
        return self._user_api_authenticate_project_oapg(

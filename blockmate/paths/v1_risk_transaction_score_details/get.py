...
class BaseApi(api_client.Api):
    ...
    def _get_transaction_risk_score_details_oapg(
        self: api_client.Api,
        ...
        host = self._get_host_oapg('get_transaction_risk_score_details', _servers, host_index)
...
class GetTransactionRiskScoreDetails(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_transaction_risk_score_details(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        host_index: typing.Optional[int] = None,
        ...
        return self._get_transaction_risk_score_details_oapg(

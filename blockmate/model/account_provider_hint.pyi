...
class AccountProviderHint(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_name", "account_type", "account_url", "description", "url", "fields", "oauth", "intro", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_name", "account_type", "account_url", "description", "url", "fields", "oauth", "intro", ], str]):
        return super().get_item_oapg(name)

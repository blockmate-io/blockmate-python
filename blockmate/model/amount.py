...
class Amount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["value", "currency", "currency_name", "currency_symbol", "image_name", "image_url", "converted_currency", "converted_value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["value", "currency", "currency_name", "currency_symbol", "image_name", "image_url", "converted_currency", "converted_value", ], str]):

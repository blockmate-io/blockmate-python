...
class User(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uuid", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uuid", "name", ], str]):

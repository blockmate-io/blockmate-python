...
------------- | ------------- | -------------
[**auth_user**](#auth_user) | **get** /v1/users/{id}/auth | Authenticate user
[**create_user**](#create_user) | **post** /v1/users | Create user
[**delete_user**](#delete_user) | **delete** /v1/users/{id} | Delete user
[**get_user**](#get_user) | **get** /v1/users/{id} | Get user
[**list_users**](#list_users) | **get** /v1/users | List users
[**update_user**](#update_user) | **post** /v1/users/{id} | Update user

# **auth_user**
<a name="auth_user"></a>
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} auth_user(id)
...
with blockmate.ApiClient(configuration) as api_client:
    ...
    path_params = {
        'id': "4301140e-d639-11ec-9120-00155d03ab64",
    }
    try:
        # Authenticate user
        ...
        print("Exception when calling UserManagementApi->auth_user: %s\n" % e)
```
### Parameters
...
200 | [ApiResponseFor200](#auth_user.ApiResponseFor200) | UserJWT
400 | [ApiResponseFor400](#auth_user.ApiResponseFor400) | Bad Request
401 | [ApiResponseFor401](#auth_user.ApiResponseFor401) | Unauthorized
404 | [ApiResponseFor404](#auth_user.ApiResponseFor404) | Not Found

#### auth_user.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} delete_user(id)

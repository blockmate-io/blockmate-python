<a name="__pageTop"></a>
# blockmate.apis.tags.user_account_management_api.UserAccountManagementApi
...
```python
import blockmate
from blockmate.apis.tags import user_account_management_api
...
with blockmate.ApiClient(configuration) as api_client:
    ...
    api_instance = user_account_management_api.UserAccountManagementApi(api_client)
    ...
    try:
        ...
        print("Exception when calling UserAccountManagementApi->connect_account: %s\n" % e)
...
with blockmate.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling UserAccountManagementApi->delete_account: %s\n" % e)
```
### Parameters
...
with blockmate.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling UserAccountManagementApi->get_account_hint: %s\n" % e)
```
### Parameters
